...
public class AddMovie extends javax.swing.JFrame {
    AddItemController<AddMovie> addItemController;
    Owner owner;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Item movie = new Movie(0, "Movie", jTextField2.getText(), Double.parseDouble(jTextField5.getText()), true, jTextField1.getText(), jTextField4.getText(), Integer.parseInt(jTextField3.getText()), jTextField6.getText(), jTextField7.getText());
        try {
            addItemController.addItem(owner, movie);
