...
public class AddGame extends javax.swing.JFrame {
    AddItemController<AddGame> addItemController;
    Owner owner;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Item game = new Game(0, "Game", jTextField2.getText(), Double.parseDouble(jTextField5.getText()), true, jTextField1.getText(), jTextField4.getText(), jTextField3.getText(), jTextField6.getText());
        try {
            addItemController.addItem(owner, game);
