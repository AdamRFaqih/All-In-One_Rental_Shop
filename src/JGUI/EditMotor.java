 ...
 */
public class EditMotor extends javax.swing.JFrame {
    Owner owner;
    Motor motor;
    EditItemController<EditMotor> editItemController;
     ...
     */
    public EditMotor(Owner owner, Motor item) {
        initComponents();
        this.owner = owner;
        this.motor = item;
        this.editItemController = new EditItemController<>();
        editItemController.setEditForm(this);
        this.jTextField2.setText(motor.getDescription());
        this.jTextField5.setText(String.valueOf(motor.getRentalChargePerDay()));
        this.jTextField1.setText(motor.getPabrikan());
        this.jTextField4.setText(motor.getModel());
        this.jTextField3.setText(String.valueOf(motor.getTahunKeluar()));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMotor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditMotor(new Owner(), new Motor()).setVisible(true);
            }
        });
    }
