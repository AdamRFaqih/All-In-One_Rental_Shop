...
public class AddMobil extends javax.swing.JFrame {
    AddItemController<AddMobil> addItemController;
    Owner owner;
    ...
    public AddMobil() {
        ...
        addItemController.setAddController(this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Item mobil = new Mobil(0, "Motor", jTextField2.getText(), Double.parseDouble(jTextField5.getText()), true, jTextField1.getText(), jTextField4.getText(), Integer.parseInt(jTextField3.getText()), jTextField6.getText());
        try {
            addItemController.addItem(owner, mobil);
